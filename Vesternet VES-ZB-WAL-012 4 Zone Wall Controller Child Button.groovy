/**
 *	Vesternet VES-ZB-WAL-012 4 Zone Wall Controller Child Button
 * 
 */
import groovy.json.JsonOutput
metadata {
	definition (name: "Vesternet VES-ZB-WAL-012 4 Zone Wall Controller Child Button", namespace: "Vesternet", author: "Vesternet", ocfDeviceType: "x.com.st.d.remotecontroller") {
		capability "Button"
		capability "Sensor"
	}
}
