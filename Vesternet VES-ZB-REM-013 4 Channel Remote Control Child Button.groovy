/**
 *	Vesternet VES-ZB-REM-013 4 Channel Remote Control Child Button
 * 
 */
import groovy.json.JsonOutput
metadata {
	definition (name: "Vesternet VES-ZB-REM-013 4 Channel Remote Control Child Button", namespace: "Vesternet", author: "Vesternet", ocfDeviceType: "x.com.st.d.remotecontroller") {
		capability "Button"
		capability "Sensor"
	}
}
